...
- 🤗 **[Model weights on Hugging Face](https://huggingface.co/GuillaumeCassez)** — 5-fold MedNeXt-B checkpoints (BraTS) and 3-seed ConvNeXt-V2+UPerNet checkpoints (Cityscapes), `safetensors`, MIT.
